...
if(isset($_POST['submit']))
{
    ...
    $query="INSERT INTO book_tb(Accessionnumber,Title,Authors,Edition,Publisher)VALUES('{$number}','{$title}','{$authors}','{$edition}','{$publisher}')";
...
<?php
$s="SELECT * FROM book_tb WHERE Title LIKE '%$titles%'";
